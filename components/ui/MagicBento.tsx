...
const DEFAULT_GLOW_COLOR = '132, 204, 22'; // Website's primary green color
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-4 p-6 max-w-[80rem] select-none relative transform scale-100"
    style={{ fontSize: 'clamp(1rem, 0.9rem + 0.5vw, 1.4rem)' }}
    ref={gridRef}
  >
    {children}
  </div>
      ...
      <style>
        {`
          .bento-section {
            ...
            --background-card: color-mix(in lab, var(--backgroundLight) 80%, var(--text) 5%);
            --text-color: var(--text);
            --text-primary: var(--primary);
            --text-title: var(--textTitle);
            --text-body: var(--textBody);
          }
          
          [data-theme='light'] .bento-section {
            --border-color: color-mix(in lab, var(--text) 25%, transparent);
            --background-card: color-mix(in lab, var(--white) 85%, var(--text) 15%);
            --text-color: var(--black);
            --text-primary: var(--black);
            --text-title: var(--black);
            --text-body: color-mix(in lab, var(--black) 80%, transparent);
          }
          ...
          [data-theme='dark'] .card--border-glow:hover {
            background: color-mix(in lab, var(--backgroundLight) 90%, var(--primary) 10%) !important;
          }
          
          [data-theme='light'] .card--border-glow:hover {
            background: color-mix(in lab, var(--white) 75%, var(--text) 25%) !important;
            box-shadow: 0 4px 20px color-mix(in lab, var(--text) 20%, transparent), 0 0 30px color-mix(in lab, var(--text) 10%, transparent);
          }
          ...
          .particle-container:hover {
            box-shadow: 0 4px 20px color-mix(in lab, var(--primary) 15%, transparent), 0 0 30px rgba(${glowColor}, 0.1);
          }
